...
impl ToXml for CTTransitionSoundAction {
    ...
    fn is_empty_element(&self) -> bool {
        if self.st_snd.is_some() { return false; }
        if self.end_snd.is_some() { return false; }
        #[cfg(feature = "extra-children")]
...
impl ToXml for SlideTransition {
    ...
    fn is_empty_element(&self) -> bool {
        if self.blinds.is_some() { return false; }
        if self.checker.is_some() { return false; }
        if self.circle.is_some() { return false; }
        if self.dissolve.is_some() { return false; }
        if self.comb.is_some() { return false; }
        if self.cover.is_some() { return false; }
        if self.cut.is_some() { return false; }
        if self.diamond.is_some() { return false; }
        if self.fade.is_some() { return false; }
        if self.newsflash.is_some() { return false; }
        if self.plus.is_some() { return false; }
        if self.pull.is_some() { return false; }
        if self.push.is_some() { return false; }
        if self.random.is_some() { return false; }
        if self.random_bar.is_some() { return false; }
        if self.split.is_some() { return false; }
        if self.strips.is_some() { return false; }
        if self.wedge.is_some() { return false; }
        if self.wheel.is_some() { return false; }
        if self.wipe.is_some() { return false; }
        if self.zoom.is_some() { return false; }
        if self.snd_ac.is_some() { return false; }
...
impl ToXml for CTTLIterateData {
    ...
    fn is_empty_element(&self) -> bool {
        if self.tm_abs.is_some() { return false; }
        if self.tm_pct.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTextTargetElement {
    ...
    fn is_empty_element(&self) -> bool {
        if self.char_rg.is_some() { return false; }
        if self.p_rg.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLShapeTargetElement {
    ...
    fn is_empty_element(&self) -> bool {
        if self.bg.is_some() { return false; }
        if self.sub_sp.is_some() { return false; }
        if self.ole_chart_el.is_some() { return false; }
        if self.tx_el.is_some() { return false; }
        if self.graphic_el.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTimeTargetElement {
    ...
    fn is_empty_element(&self) -> bool {
        if self.sld_tgt.is_some() { return false; }
        if self.snd_tgt.is_some() { return false; }
        if self.sp_tgt.is_some() { return false; }
        if self.ink_tgt.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTimeCondition {
    ...
    fn is_empty_element(&self) -> bool {
        if self.tgt_el.is_some() { return false; }
        if self.tn.is_some() { return false; }
        if self.rtn.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTimeConditionList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.cond.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTimeNodeList {
    ...
    fn is_empty_element(&self) -> bool {
        if self.par.is_some() { return false; }
        if self.seq.is_some() { return false; }
        if self.excl.is_some() { return false; }
        if self.anim.is_some() { return false; }
        if self.anim_clr.is_some() { return false; }
        if self.anim_effect.is_some() { return false; }
        if self.anim_motion.is_some() { return false; }
        if self.anim_rot.is_some() { return false; }
        if self.anim_scale.is_some() { return false; }
        if self.cmd.is_some() { return false; }
        if self.set.is_some() { return false; }
        if self.audio.is_some() { return false; }
        if self.video.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLCommonTimeNodeData {
    ...
    fn is_empty_element(&self) -> bool {
        if self.st_cond_lst.is_some() { return false; }
        if self.end_cond_lst.is_some() { return false; }
        if self.end_sync.is_some() { return false; }
        if self.iterate.is_some() { return false; }
        if self.child_tn_lst.is_some() { return false; }
        if self.sub_tn_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLBehaviorAttributeNameList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.attr_name.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLAnimVariant {
    ...
    fn is_empty_element(&self) -> bool {
        if self.bool_val.is_some() { return false; }
        if self.int_val.is_some() { return false; }
        if self.flt_val.is_some() { return false; }
        if self.str_val.is_some() { return false; }
        if self.clr_val.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTimeAnimateValue {
    ...
    fn is_empty_element(&self) -> bool {
        if self.value.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLTimeAnimateValueList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.tav.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLByAnimateColorTransform {
    ...
    fn is_empty_element(&self) -> bool {
        if self.rgb.is_some() { return false; }
...
impl ToXml for CTTLTemplateList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.tmpl.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLBuildParagraph {
    ...
    fn is_empty_element(&self) -> bool {
        if self.tmpl_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTLGraphicalObjectBuild {
    ...
    fn is_empty_element(&self) -> bool {
        if self.bld_as_one.is_some() { return false; }
        if self.bld_sub.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTBuildList {
    ...
    fn is_empty_element(&self) -> bool {
        if self.bld_p.is_some() { return false; }
        if self.bld_dgm.is_some() { return false; }
        if self.bld_ole_chart.is_some() { return false; }
        if self.bld_graphic.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for SlideTiming {
    ...
    fn is_empty_element(&self) -> bool {
        if self.tn_lst.is_some() { return false; }
        if self.bld_lst.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
...
impl ToXml for CTSlideRelationshipList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.sld.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTCustomerDataList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.cust_data.is_empty() { return false; }
        if self.tags.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for EGExtensionList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.ext.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTCommentAuthorList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.cm_author.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTCommentList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.cm.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTOleObject {
    ...
    fn is_empty_element(&self) -> bool {
        if self.embed.is_some() { return false; }
        if self.link.is_some() { return false; }
        if self.picture.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTControlList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.control.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for SlideIdList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.sld_id.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTSlideMasterIdList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.sld_master_id.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTNotesMasterIdList {
    ...
    fn is_empty_element(&self) -> bool {
        if self.notes_master_id.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTHandoutMasterIdList {
    ...
    fn is_empty_element(&self) -> bool {
        if self.handout_master_id.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTEmbeddedFontList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.embedded_font.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTCustomShowList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.cust_show.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for Presentation {
    ...
    fn is_empty_element(&self) -> bool {
        if self.sld_master_id_lst.is_some() { return false; }
        if self.notes_master_id_lst.is_some() { return false; }
        if self.handout_master_id_lst.is_some() { return false; }
        if self.sld_id_lst.is_some() { return false; }
        if self.sld_sz.is_some() { return false; }
        false
    }
}
...
impl ToXml for CTShowProperties {
    ...
    fn is_empty_element(&self) -> bool {
        if self.show_type.is_some() { return false; }
        if self.slide_list_choice.is_some() { return false; }
        if self.pen_clr.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
...
impl ToXml for CTPresentationProperties {
    ...
    fn is_empty_element(&self) -> bool {
        if self.html_pub_pr.is_some() { return false; }
        if self.web_pr.is_some() { return false; }
        if self.prn_pr.is_some() { return false; }
        if self.show_pr.is_some() { return false; }
        if self.clr_mru.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
...
impl ToXml for CTApplicationNonVisualDrawingProps {
    ...
    fn is_empty_element(&self) -> bool {
        if self.ph.is_some() { return false; }
        if self.cust_data_lst.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
...
impl ToXml for EGChildSlide {
    ...
    fn is_empty_element(&self) -> bool {
        if self.clr_map_ovr.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTSlideMasterTextStyles {
    ...
    fn is_empty_element(&self) -> bool {
        if self.title_style.is_some() { return false; }
        if self.body_style.is_some() { return false; }
        if self.other_style.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
...
impl ToXml for CTSlideLayoutIdList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.sld_layout_id.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTTagList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.tag.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTGuideList {
    ...
    fn is_empty_element(&self) -> bool {
        if !self.guide.is_empty() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
    }
...
impl ToXml for CTViewProperties {
    ...
    fn is_empty_element(&self) -> bool {
        if self.normal_view_pr.is_some() { return false; }
        if self.slide_view_pr.is_some() { return false; }
        if self.outline_view_pr.is_some() { return false; }
        if self.notes_text_view_pr.is_some() { return false; }
        if self.sorter_view_pr.is_some() { return false; }
        if self.notes_view_pr.is_some() { return false; }
        if self.grid_spacing.is_some() { return false; }
        if self.ext_lst.is_some() { return false; }
        #[cfg(feature = "extra-children")]
        if !self.extra_children.is_empty() { return false; }
        true
